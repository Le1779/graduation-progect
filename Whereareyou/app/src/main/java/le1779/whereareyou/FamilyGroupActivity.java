...
public class FamilyGroupActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_family_group);gpsTracker = new GPSTracker(this);
        imm = ((InputMethodManager)getSystemService(INPUT_METHOD_SERVICE));
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolBar);
        setSupportActionBar(toolbar);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.family_map);
        ...
        relativeLayout = (RelativeLayout)findViewById(R.id.family_area_layout);
        ...
        view=new DrawView(FamilyGroupActivity.this, windowWidth/2, windowHeight/2, 300);
        view.invalidate();
    ...
    private void initSeekBar(){
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                ...
                view = new DrawView(FamilyGroupActivity.this, windowWidth / 2, windowHeight / 2, seekProgress);
                view.invalidate();
                relativeLayout.addView(view);
        ...
        if (actionBar != null) {
            ...
            next_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Geocoder geocoder = new Geocoder(FamilyGroupActivity.this, Locale.getDefault());
                    ...
                    if(!update_str.equals("")&&!update_str.equals(null)) {
                        creat_group_dialog = ProgressDialog.show(FamilyGroupActivity.this, " 新增中", "請等待...", true);
                        new Thread(wait_update_runnable).start();
                        //Toast.makeText(getApplicationContext(), update_str, Toast.LENGTH_SHORT).show();
                    }else {
                        Toast.makeText(getApplicationContext(), "你還沒設定門禁的時間", Toast.LENGTH_SHORT).show();
                    }
                }
            });
    ...
    Runnable wait_update_runnable = new Runnable() {
        ...
        public void run() {
            ...
            dataBase.creatFamilyGroup(group_name, user_id, latitude, longitude, area_distance, update_str);
    ...
    private void showAlertDialog(final int mon, final int day, final int h, final int m){
        ...
        LayoutInflater inflater = LayoutInflater.from(FamilyGroupActivity.this);
        ...
        new AlertDialog.Builder(FamilyGroupActivity.this)
                .setTitle("設定門禁時間")
                .setView(v)
                .setCancelable(false)
